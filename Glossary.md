...
| **Agentic system** | Production system combining agents, orchestration, evals, safety, and ops | 00-04, 03-01 |
...
| **Checkpointing** | Persisting agent state so runs can resume after failure/interrupt | 03-03 |
...
| **Critic / Reflection** | Secondary pass that reviews/improves an artifact | 03-04, 05-02 |
| **Deterministic spine** | Non-LLM policy/code path that must stay auditable | 00-06, 00-04 |
...
| **HITL** | Human-in-the-loop approval or edit before side effects | 03-03 |
...
| **KV cache** | Cached key/value attention tensors speeding autoregressive decode | 01-01, 01-05 |
...
| **Plan-and-Execute** | Plan first, then execute steps (often with separate models) | 03-04, 12-01 |
...
| **Router** | Classifies intent/difficulty and selects path/model/agent | 03-04 |
...
| **vLLM** | High-throughput LLM inference server | 01-05 |
