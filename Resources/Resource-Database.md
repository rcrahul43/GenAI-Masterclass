...
|------:|------------------------|---------|
| 0 | GenAI intros · chat API docs · Python · FastAPI · Math | [Foundations](#foundations--phase-0) |
...
> **Order:** GenAI ideas (`00-01`) first → Python/APIs → Math → Rules/Agents. Do not start Phase 0 with linear algebra alone.
