...
|---------|------|---------|
| Hello-LLM CLI (+ mock) | Embedded in [00-01](../Modules/00-Foundations/00-01-AI-Engineering-Mindset.md) | 00 |
| Retention / decision-support rules engine | [00-03](../Modules/00-Foundations/00-03-BankCo-Decision-Support-Warmup.md) | 00 |
