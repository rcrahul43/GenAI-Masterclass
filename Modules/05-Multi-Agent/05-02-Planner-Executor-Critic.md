...
Aligns with [00-06](../00-Foundations/00-06-BankCo-Decision-Support-Warmup.md) (worked example; previewed in [00-01](../00-Foundations/00-01-GenAI-From-Scratch.md)): policy in code, language in models.
